...
export class SplashComponent implements OnInit {
  ...
  slides = [
    {"no": 1,class1:"first",class2:"casting-content",class3:"slide-btn1",logo: "../../assets/img/white_logo.webp",img: "../../assets/img/img/GirlImg.webp",title:"Casting Call",des:"Get updates on the most recent casting calls of features films, TV commercials and other medium. Resgister NOW!", skipBtn:"Skip"},
